...
<head>
    ...
    <script>
        function OrderClick(){
            ...
            rollerRadio = document.getElementById("optRoller");
            ...
            wingsCheckbox = document.getElementById("optWings");
            krusherCheckBox = document.getElementById("optKrusher");
    ...
    <body>
       <header>
            <img src="../../../public/images/kfc top.jpg" width="100%" height="180">
        </header>
        <section>
            <div class="accordion" id="orderForm"></div>
            ...
            <div class="accordion-collapse collapse show" id="customer" data-bs-parent="#orderForm">
                <div class="accordion-body">
                    <dl>
                        <dt>Customer Name</dt>
                        <dd><input type="text" class="form-control" id="text name"></dd>
                        <dt>Mobile Number</dt>
                        <dd><input type="text" class="form-control id="mobile Number"></dd>
                    </dl>
                </div>
            </div>
          </div>
            ...
            <div class="accordion-collapse collapse" id="meal" data-bs-parent="#orderForm">
                <div class="accordion-body">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <img src="../../../public/images/burger.jpg" class="card-img-top" height="250">
                                <div class="card-header">
                                    <h2>OMG Burger</h2>
                                </div>
                                <div class="card-footer">
                                    <h3> <input type="radio" class="form-check-input" value="OMG Burger" id="optBurger" name="meal"> &#8377; 120/- </h3>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card">
                                <img src="../../../public/images/chicken roll.jpg" class="card-img-top" height="250">
                                <div class="card-header">
                                    <h2>OMG Roller</h2>
                                </div>
                                <div class="card-footer">
                                    <h3> <input type="radio" class="form-check-input" value="OMG Roller" id="optRoller" name="meal"> &#8377; 100/- </h3>
                                </div>
                            </div>
                        </div>
                    </div>
      ...
      <div class="accordion-item">
        ...
        <div class="accordion-accordion collapse" id="adon" data-bs-parent="#orderform">
            <div class="accordion-body">
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <img src="../../../public/images/Hot wings.jpg">
                            <h2>Hot Wings</h2>
                        </div>
                        <div class="card-footer">
                            <h3> <input type="checkbox" id="optWings" value="Hot Wings" class="form-check-input">  &#8377; 60/- </h3>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <img src="../../../public/images/krusher brownie.jpg" class="card-img-top" height="250">
                    <div class="card-header">
                        <h2>Krusher Brownie</h2>
                    </div>
                    <div class="card-footer">
                        <h3> <input type="checkbox" id="optKrusher" value="Krusher Brownie" class="form-check-input">  &#8377; 40/- </h3>
                </div>
            </div>
        </div>
      </div>
